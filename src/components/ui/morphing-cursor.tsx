...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
    ...
    return (
        ...
        >
            ...
            <span className="text-[inherit] font-[inherit] tracking-[inherit] text-white">{text}</span>
            ...
            >
                ...
                >
                    <span className="text-[inherit] font-[inherit] tracking-[inherit] text-black whitespace-nowrap">
                        {hoverText}
                    </span>
                </div>
            </div>
